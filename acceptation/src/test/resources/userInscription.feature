Feature: User Inscription
  ...
  L'utilisateur doit remplir un formulaire avec plusiers champs qui sont validés pour inscrire l'utilisateur
  à la plateforme ou pour l'indiquer les erreur au moment du remplissage.
