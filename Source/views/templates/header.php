        ...
        <div id="navbar">
            <ul class="nav navbar-nav">
                ...
                <?php if (isset($_SESSION['role']) && $_SESSION['role'] == "ADMIN") { ?>
                    <li><a href="../administration/list_users.php">Utilisateurs</a></li>
                <?php } ?>
                <li><a href="../oeuvre/listing.php">Oeuvres</a></li>
                <li><a href="../artwork/">Oeuvres par catégorie</a></li>
                <?php if (isset($_SESSION['role']) && $_SESSION['role'] == "ADMIN") { ?>
                    <li><a href="../opCategorie/listeCategorieView.php">Catégories</a></li>
                <?php } ?>
            </ul>
...
<div class="container">
    ...
    if (isset($_SESSION['error'])) {
        echo '<p class="alert alert-danger" name="error">' . $_SESSION['error'] . '</p>';
