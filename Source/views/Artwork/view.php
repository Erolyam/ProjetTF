    ...
    <div class="well">
        ...
        <?php if (isset($_SESSION['username'])) {
            if ($_SESSION['idUser'] == $comment['User_idUser']) {
                ...
                <form enctype="multipart/form-data" action="../../actions/AllArtwork.php" method="post">
                    <textarea name="comment" disabled="true" id="<?php echo 'dd' . $comment['idComment'] ?>"
                              class="form-control"><?php echo $comment['comment']; ?>
                    </textarea>
                    <input type="button" name="bouton" value="Editer" class="btn btn-warning"
