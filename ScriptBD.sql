...
CREATE TABLE IF NOT EXISTS `m2test5`.`Artwork` (
  ...
  `category_idCategory` INT COMMENT '',
  `owner_idUser` INT COMMENT '',
  `artwork_picture` VARCHAR(256) NULL COMMENT 'Profile picture file directory (ex., \'/image/diego_image.jpg\')',
